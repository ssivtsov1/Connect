...
//        debug($flag);
            ...
            NavBar::begin([
                'brandLabel' => 'Стандартне приєднання до електромереж',
        ...
        if($flag){
            ...
            {echo Nav::widget([
                ...
                'items' => [
                    ...
                    ['label' => 'Розрахунок вартості', 'url' => ['/site/index']],
//                    ['label' => 'Про программу', 'url' => ['/site/about']],
                    ['label' => 'Особовий кабінет', 'url' => ['/site/cabinet']],
...
//                    ['label' => 'Про программу', 'url' => ['/site/about']],
        ...
        <?php if(!$flag): ?>
            ...
            <div class="rh1"><a href="/Connect/web"><img src="../calc1.png" alt="" /></a>
            <div><a href="/Connect/web">Розрахунок вартості</a></div>
            </div>
